...
public class OrderHistory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Account a = (Account) sessionx.getAttribute("acc");// lấy account của thằng khách hàng đang login
        
        loadDAO ld=new loadDAO();
        
        List<OrderDetail> list =ld.getAllOrderDetailByCustomerName(a.getFullName());// list tất cả những đơn hàng mà thằng account đang đăng nhập đã từng mua
        //set status number để dễ xử lí trong phần đành giá
        for (OrderDetail o : list) {
            if(ld.searchFeedbackByOrderID(o.getOrderID())!=null){
