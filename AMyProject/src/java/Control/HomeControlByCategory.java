 ...
 * @author DELL
 */
@WebServlet(name = "HomeControlByCategory", urlPatterns = {"/HomeControlByCategory"})
public class HomeControlByCategory extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Product> listP=ld.getProductByCid(cid);// lấy tất cả product nhưng bằng cid
