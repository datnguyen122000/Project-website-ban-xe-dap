                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                                    ...
                                    <form action="updateAndDelete" method="get">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>ID</label>
                                                <input readonly value="${o.id}" name="id" type="text" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Name</label>
                                                <input readonly value="${o.name}" name="name" type="text" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label>Image</label>
                                            ...
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input name="title" value="${o.title}" type="text" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>CateID</label>
                                                <input readonly name="cateID" value="${o.cateID}" type="text" class="form-control" required>
                                            </div>
                                            <div class="form-group">
                                                <label>amoutBuy</label>
                                                <input readonly name="amoutBuy" value="${o.amoutBuy}" type="text" class="form-control" required>
                                            </div>
                        ...
                        <div id="deleteEmployeeModal${o.id}" class="modal fade">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form action="updateAndDelete?id=${o.id}"method="post">
                                        <div class="modal-header">						
                    ...
                    <ul class="pagination">
                        ...
                        <c:forEach var = "i" begin = "1" end = "${numOfPage}">
                            <c:if test="${indexPage==i}">
                                <li class="page-item active"><a href="loadToManagerProduct?indexPage=${i}" class="page-link">${i}</a></li>
                                </c:if>
                                <c:if test="${indexPage!=i}">
                                <li class="page-item"><a href="loadToManagerProduct?indexPage=${i}" class="page-link">${i}</a></li>
